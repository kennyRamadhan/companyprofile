...
const content = {
  id: {
    description:
      "Perusahaan konstruksi terpercaya yang menyediakan layanan pembangunan, renovasi, dan desain arsitektur profesional sejak 2014.",
    ...
    copyright: "© 2026 Bangun Jaya Abadi. All rights reserved.",
  },
  en: {
    description:
      "A trusted construction company providing professional building, renovation, and architectural design services since 2014.",
    quickLinksTitle: "Menu",
    quickLinks: [
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div className="lg:col-span-1">
            <div className="flex items-center gap-2 mb-4">
              <div className="w-10 h-10 bg-secondary rounded-lg flex items-center justify-center font-bold text-white text-lg">
                B
              </div>
              <span className="font-bold text-xl">Bangun Jaya Abadi</span>
            </div>
          ...
          {/* Quick links */}
          <div>
            <h4 className="font-bold text-lg mb-4">{t.quickLinksTitle}</h4>
          ...
          {/* Services */}
          <div>
            <h4 className="font-bold text-lg mb-4">{t.servicesTitle}</h4>
            <ul className="space-y-2.5">
